...
echo:                                                          
call :_color2 %_White% "          [3] disable Windows Firewall  " %_col% "[%_status%]"
echo:          _____________________________________________ 
echo:                                                                                                                     
echo:          [6]go back                                      
echo:          _____________________________________________
...
set link=https://www.microsoft.com/en-us/d/windows-10-home/d76qx4bznwk4?rtc=1
call :download
set link=https://www.microsoft.com/en-US/store/cart?route=checkout&wa=wsignin1.0
call :download
